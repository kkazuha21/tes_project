      ...
      <el-container>
        ...
        <el-aside width="220px" class="sidebar">
          ...
          <div class="sidebar-header">
            ...
            <span class="sidebar-title">教师工作台</span>
          </div>
          ...
          >
            ...
            <el-menu-item index="/teacher/bookings">
              <i class="ri-calendar-line"></i>
              <span>预约管理</span>
            </el-menu-item>
            <el-menu-item index="/teacher/tickets">
              <i class="ri-tools-line"></i>
              <span>报修处理</span>
            </el-menu-item>
            <el-menu-item index="/teacher/my-bookings">
...
const activeMenu = ref('/teacher/devices')
